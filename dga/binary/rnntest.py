...
testlabels = pd.read_csv('sparkpaper/testlabel.csv', header=None)

testlabel = testlabels.iloc[:,0:1]


#train = pd.read_csv('sparkpaper/train.txt', header=None)
test = pd.read_csv('sparkpaper/test.txt', header=None)
...
model.load_weights("logs/rnn/checkpoint-00.hdf5")

y_pred = model.predict_classes(X_test)
#np.savetxt('spark/0.965', y_pred)
